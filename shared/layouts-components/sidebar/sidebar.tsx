  ...
  return (
    <Fragment>
      ...
      <aside
        ...
        // Sidebar ana rengi (primary) template mavisi yerine betprint yeşili —
        // aktif ve hover menü öğeleri yeşil olur (alt öğelere cascade eder).
        style={
          {
            "--primary": "21 128 61",
      ...
      >
        <div className="main-sidebar-header">
          <div className="header-logo relative flex items-center">
            {/* Betprint mağaza logosu: yeşil "shop". Açık/koyu tema ve
                daraltılmış (icon) durumların hepsi için — "ONE" görseli kaldırıldı. */}
            <Link href="/shop" className="desktop-logo flex items-center">
              <span className="text-2xl font-extrabold leading-none text-[#15803d]">
                shop
              </span>
            </Link>
            <Link href="/shop" className="desktop-dark flex items-center">
              <span className="text-2xl font-extrabold leading-none text-[#15803d]">
                shop
              </span>
            </Link>
            <Link href="/shop" className="desktop-white flex items-center">
              <span className="text-2xl font-extrabold leading-none text-[#15803d]">
                shop
              </span>
            </Link>
            {/* Daraltılmış (icon) durum: mağaza ikonu */}
            <Link
              href="/shop"
              className="toggle-logo flex items-center justify-center"
            >
              <i className="ri-store-2-line text-2xl text-[#15803d]"></i>
            </Link>
            <Link
              href="/shop"
              className="toggle-dark flex items-center justify-center"
            >
              <i className="ri-store-2-line text-2xl text-[#15803d]"></i>
            </Link>
            <Link
              href="/shop"
              className="toggle-white flex items-center justify-center"
            >
              <i className="ri-store-2-line text-2xl text-[#15803d]"></i>
            </Link>
          </div>
